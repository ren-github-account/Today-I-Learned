...
|コールバック関数|「関数を受け取る関数」に渡すための関数のこと。「関数を受け取る関数」は**高級関数**と呼ばれる。コールバック関数は、**関数の引数に渡す関数のこと**とも言い換えられる。なぜコールバック関数のようなことが可能かというと、JavaScriptでは関数は「値」として変数に代入して使うことができることが関係している。( 参照:[古都こと](https://sbfl.net/blog/2019/02/08/javascript-callback-func/) )|
