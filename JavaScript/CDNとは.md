...
同一オリジンポリシー(Same Origin Policy)とは、異なるオリジンから読み込まれたリソースへのアクセスをブロックすることにより、元オリジンで読み込まれたリソースに対して悪い影響を及ぼさないようにすることを目的としたWeb ブラウザが持つセキュリティ機能のこと。頭文字をとって**SOP**とも呼ばれる。
