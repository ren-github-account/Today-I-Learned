...
**注意点**として、上記のコードでは関数を後から宣言して呼び出しているが、この関数を定義する前から呼び出すことは「巻き上げ」と呼ばれていてバグの原因となるため推奨されないとのこと。( 参照:[qiita](https://qiita.com/redrabbit1104/items/2308a79b4d670f5019b9) )
