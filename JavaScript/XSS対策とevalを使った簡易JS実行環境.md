...
|`...`|この点三つのことをスプレッド構文と呼ぶ。先頭に付けることで、**配列や文字列などの反復可能オブジェクトを展開することができる。** 参照:[MDN](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Operators/Spread_syntax)|
