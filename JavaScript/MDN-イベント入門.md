...
|innerHTMLプロパティ|HTML内にあるテキストや`<p></p>`などのタグそれ自体などを置き換えたり取得したりできる機能を持つ。(参照:[innerHTMLの使い方](http://javascriptmania.blog111.fc2.com/blog-entry-18.html)) 注意点としてinnerHTMLはXSS防止の観点から非推奨で、代わりに`textContentプロパティ`の使用が推奨される。|
|CSSセレクター||
