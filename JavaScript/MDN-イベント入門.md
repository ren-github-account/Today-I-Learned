...
|Elementオブジェクト|上述のElementクラスを使って作成されたオブジェクトのこと。Elementオブジェクトのプロパティの具体例には**innerHTMLプロパティ**などがある詳しくは[こちら](https://developer.mozilla.org/ja/docs/Web/API/Element/innerHTML)|
