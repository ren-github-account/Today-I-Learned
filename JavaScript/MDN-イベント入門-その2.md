...
* [デフォルトのアクションを止める](#デフォルトのアクションを止める)
...
**デフォルトアクションとは**、具体的には、リンクをクリックしたら「リンク先」へ飛ぶことや、フォームの送信ボタンを押すとフォームが送信されることなどのことを指し、特別なことをしなくともデフォルトで備わっている動作のこと。参照:[イベントオブジェクトのメソッド](https://uhyohyo.net/javascript/3_5.html)
