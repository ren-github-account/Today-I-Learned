...
仕様書CSS2.1の中にのボックスモデルの章の中に、「Box dimensions」という節がある。そこには以下の記述がある。
...
>
>コンテンツエッジまたは内側エッジ
     コンテンツのエッジは、ボックスの幅と高さによって指定される四角形を囲みます。これらの四角形は、多くの場合、要素のレンダリングされたコンテンツに依存します。 4 つのコンテンツ エッジは、ボックスのコンテンツ ボックスを定義します。
>
>パディングエッジ
