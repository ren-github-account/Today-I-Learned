...
この8pxのマージンは上下左右に設定されているのだけど、このうちtopとbottom、つまり上下のマージンが相殺されて8pxとなり、html要素のコンテンツ領域に形成される包含ブロックで高さとして表示されていたわけだ。
...
html要素のコンテンツエッジのwidthは筆者の環境の場合、1280だった。
